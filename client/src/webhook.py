...
config = {
    ...
    'VERIFY_TOKEN': os.getenv('VERIFY_TOKEN', '12345678'),  # WhatsApp Webhook Token
    'WHATSAPP_API_TOKEN': os.getenv('WHATSAPP_API_TOKEN')  # WhatsApp API Token
}

# Initialize FastAPI
app = FastAPI()
server_path = os.path.abspath("/home/hsbakir/mcp-odoo-integration/server/src/odoo_server.py")
...
async def webhook(request: Request):
    ...
    try:
        ...
        # Get AI-generated response from GeminiClient
        reply_message = await client.process_query(message_body)
